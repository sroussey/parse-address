# Tonga (TO) address research

ISO 3166-1 alpha-2: **to** — SEC/EDGAR mapped country.

## Convention

- Language: **English**.
- Order: **house number first**, then street name + **trailing** English type suffix (e.g. `12 Taufa'ahau Road`). Type echoed verbatim (Street, Rd, Ave, ...).
- Postcode: None. Tonga has no domestic postcode system.
- Region/state: Tongatapu, Vava'u, Ha'apai, 'Eua, Niuatoputapu, Niuafo'ou
...
Tongatapu, Vava'u, Ha'apai, 'Eua, Niuatoputapu, Niuafo'ou
