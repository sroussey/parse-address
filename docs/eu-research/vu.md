# Vanuatu (VU) address research

ISO 3166-1 alpha-2: **vu** — SEC/EDGAR mapped country.

## Convention

- Language: **English**.
- Order: **house number first**, then street name + **trailing** English type suffix (e.g. `8 Kumul Highway`). Type echoed verbatim (Street, Rd, Ave, ...).
- Postcode: None. Vanuatu has no domestic postcode system.
- Region/state: Espiritu Santo, Santo, Efate, Malekula, Tanna, Pentecost, Ambae, Ambrym, Erromango, Malo, Gaua, Shefa, Sanma, Tafea, Malampa, Penama, Torba
...
| state | island/region (Espiritu Santo) |
| postal_code | n/a (no postcode) |
| country | VU |

## Cities / localities sampled

Port Vila, Luganville, Isangel, Saratamata, Lakatoro

## Islands / regions

Espiritu Santo, Santo, Efate, Malekula, Tanna, Pentecost, Ambae, Ambrym, Erromango, Malo, Gaua, Shefa, Sanma, Tafea, Malampa, Penama, Torba
