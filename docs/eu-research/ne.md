...
- "B.P." / "BP" / "Boîte Postale" is the dominant delivery form, e.g.
  "BP 1234, Niamey". The box number is not a house number.
...
- Niamey, Arlit, Tessaoua, Dogondoutchi, Gaya, Birni-N'Konni.

## Neighbourhoods (quartiers) -- consumed and dropped
- Plateau, Yantala, Koira Kano, Terminus, Lacouroussou, Gamkallé, Maourey, Deizebon, Recasement.
