# Niue (NU) address research

ISO 3166-1 alpha-2: **nu** — SEC/EDGAR mapped country.

## Convention

- Language: **English**.
- Order: **house number first**, then street name + **trailing** English type suffix (e.g. `3 Alofi Road`). Type echoed verbatim (Street, Rd, Ave, ...).
- Postcode: None. Niue has no domestic postcode system.
...
Alofi, Alofi South, Alofi North, Avatele, Hakupu, Mutalau, Lakepa, Liku, Hikutavake, Tamakautoga, Makefu, Tuapa, Vaiea, Toi, Namukulu

## Sample count

36 samples, 4 marked `__skip` (landmark / recipient / bare-village lines that carry no street token), 32 asserted.
