...
- "B.P." / "BP" / "Boîte Postale" is the dominant delivery form, e.g.
  "BP 1234, Gombe". The box number is not a house number.

## Region / province (optional -> state)
- Rarely written; supported after the city from a restricted list:
  Kongo Central, Kwango, Kwilu, Haut-Katanga, Lualaba, Nord-Kivu, Sud-Kivu, Ituri, Tshopo, Kasaï, Kasaï-Central, Équateur.
...
- Gombe, Limete, Ngaliema, Lemba, Masina, Kalamu, Lubumbashi, Kananga, Matadi, Goma, Bukavu, Kinshasa.

## Neighbourhoods (quartiers) -- consumed and dropped
- Ma Campagne, Righini, Kingabwa, Kauka, Socimat, Joli Parc, Basoko.
