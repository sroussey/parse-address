# Marshall Islands (MH) address research

ISO 3166-1 alpha-2: **mh** — SEC/EDGAR mapped country.

## Convention

- Language: **English**.
- Order: **house number first**, then street name + **trailing** English type suffix (e.g. `7 Lagoon Road`). Type echoed verbatim (Street, Rd, Ave, ...).
- Postcode: US-style 5-digit ZIP (e.g. 96960) routed through the US postal system; modelled as an optional after-city postal with a territory abbrev (MH).
- Region/state: Majuro, Kwajalein, Jaluit, Arno, Ailinglaplap, Wotje, Ebon, Mili, Maloelap
...
| state | island/region (Majuro) |
| postal_code | 5-digit US ZIP |
| country | MH |

## Cities / localities sampled

Majuro, Delap, Uliga, Djarrit, Ebeye, Rita, Laura

## Islands / regions

Majuro, Kwajalein, Jaluit, Arno, Ailinglaplap, Wotje, Ebon, Mili, Maloelap
