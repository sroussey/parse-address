...
describe("European AddressParser construction", () => {
  it("constructs for every supported European country", () => {
    const codes = [
      ...
      "ni", "hn", "sv", "cu",
      "bw", "na", "ao", "mz",
      "gf", "gp", "mq", "re", "yt", "nc", "pf", "wf", "pm", "bl", "mf",
      "ag", "ai", "dm", "gd", "kn", "lc", "ms", "tc", "vc",
      "pr", "vi", "gu", "as", "mp",
      "ws", "to", "vu", "sb", "ki", "fm", "mh", "pw", "ck", "nr", "tv", "nu",
      "bf", "bj", "ml", "ne", "tg", "ga", "cg", "cd", "mg", "mr",
      "gm", "ls", "lr", "mw", "rw", "sl", "sz", "sh", "cv", "gw", "st",
      "aw", "ax", "sj", "va", "gq",
      "sc", "fk", "nf", "tk", "pn",
      "ht", "bi", "cf", "gn", "td", "dj", "km",
      "tl", "vn", "az",
      "ir", "af",
      "eg", "ly", "sd", "eh",
      "iq", "om", "ye",
