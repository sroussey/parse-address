...
// BF address configuration -- French, number-first, prefix voie type.
// Numbers frequently absent; B.P. (Boîte Postale) is the dominant delivery
// form. Region/province optional (restricted list). See research-bf.md.
...
const QUARTIERS = [
  "Nongr-Massom", "Zogona", "Gounghin", "Dassasgho", "Ouaga 2000", "Patte d'Oie",
  "Koulouba", "Tanghin", "Cissin", "Dapoya", "Zone du Bois",
];

export const bfConfig: EuCountryConfig = {
  code: "bf",
  country: "BF",
  countryNames: ["Burkina Faso", "BFA", "BF"],
  ...
  regionPattern: "(?<state>Boucle\\s+du\\s+Mouhoun|Cascades|Centre|Centre-Est|Centre-Nord|Centre-Ouest|Centre-Sud|Est|Hauts-Bassins|Nord|Plateau-Central|Sahel|Sud-Ouest)",
