...
/**
 * Federated States of Micronesia (FM) address configuration.
 *
 * Language: English. Order: house NUMBER first, then the street name + a
 * TRAILING English type suffix ("12 Main Street"). Type echoed verbatim.
 * Postcode: US-style 5-digit ZIP (e.g. 96941), written after the city/state, and often present in mail routed via the US system; modelled like a US territory.
 * Region: the island/region (Pohnpei, Chuuk, Yap ...) is the final comma segment and maps to `state`.
 * PO Box is the dominant address form in Federated States of Micronesia; "PO Box", "P.O. Box",
...
export const fmConfig: EuCountryConfig = {
  code: "fm",
  country: "FM",
  countryNames: ["Federated States of Micronesia", "Micronesia", "FSM", "FM"],
