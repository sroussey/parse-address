...
/**
 * Palau (PW) address configuration.
 *
 * Language: English. Order: house NUMBER first, then the street name + a
 * TRAILING English type suffix ("9 Malakal Road"). Type echoed verbatim.
 * Postcode: US-style 5-digit ZIP (e.g. 96940), written after the city/state, and often present in mail routed via the US system; modelled like a US territory.
 * Region: the island/region (Koror, Airai, Melekeok ...) is the final comma segment and maps to `state`.
 * PO Box is the dominant address form in Palau; "PO Box", "P.O. Box",
...
export const pwConfig: EuCountryConfig = {
  code: "pw",
  country: "PW",
  countryNames: ["Palau", "Belau", "PLW", "PW"],
