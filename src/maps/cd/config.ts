...
// CD address configuration -- French, number-first, prefix voie type.
// Numbers frequently absent; B.P. (Boîte Postale) is the dominant delivery
// form. Region/province optional (restricted list). See research-cd.md.
...
const QUARTIERS = [
  "Ma Campagne", "Righini", "Kingabwa", "Kauka", "Socimat", "Joli Parc",
  "Basoko",
];

export const cdConfig: EuCountryConfig = {
  code: "cd",
  country: "CD",
  countryNames: ["République démocratique du Congo", "RD Congo", "RDC", "COD", "CD"],
  ...
  regionPattern: "(?<state>Kongo\\s+Central|Kwango|Kwilu|Haut-Katanga|Lualaba|Nord-Kivu|Sud-Kivu|Ituri|Tshopo|Kasaï|Kasaï-Central|Équateur)",
