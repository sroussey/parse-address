...
/**
 * La Réunion (RE) address configuration.
 *
 ...
 *   Postcode: 5-digit (974\d\d block) BEFORE the commune; "CEDEX nn"
...
export const reConfig: EuCountryConfig = {
  code: "re",
  country: "RE",
  countryNames: ["La Réunion", "La Reunion", "Réunion", "Reunion", "REU", "RE"],
  order: "number-street",
  ...
  postalPattern: "(?<postal_code>974\\d\\d)",
