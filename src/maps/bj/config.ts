...
// BJ address configuration -- French, number-first, prefix voie type.
// Numbers frequently absent; B.P. (Boîte Postale) is the dominant delivery
// form. Region/province optional (restricted list). See research-bj.md.
...
const QUARTIERS = [
  "Cadjèhoun", "Ganhi", "Akpakpa", "Fidjrossè", "Cocotomey", "Zongo",
  "Jéricho", "Haie Vive", "Sainte-Rita", "Gbégamey",
];

export const bjConfig: EuCountryConfig = {
  code: "bj",
  country: "BJ",
  countryNames: ["Bénin", "Benin", "BEN", "BJ"],
  ...
  regionPattern: "(?<state>Alibori|Atacora|Atlantique|Borgou|Collines|Couffo|Donga|Littoral|Mono|Ouémé|Plateau|Zou)",
