...
/**
 * Antigua and Barbuda (AG) address configuration.
 *
...
const STATES: Array<[string, string[]]> = [
  ...
  ["Saint Mary", ["Saint Mary", "St. Mary", "St Mary"]],
  ["Saint Paul", ["Saint Paul", "St. Paul", "St Paul"]],
  ["Saint Peter", ["Saint Peter", "St. Peter", "St Peter"]],
  ["Saint Philip", ["Saint Philip", "St. Philip", "St Philip"]],
  ["Barbuda", ["Barbuda"]],
  ["Redonda", ["Redonda"]],
  ["Antigua", ["Antigua"]],
];
...
export const agConfig: EuCountryConfig = {
  code: "ag",
  country: "AG",
  countryNames: ["Antigua and Barbuda", "Antigua & Barbuda", "ATG", "AG"],
  order: "number-street",
