...
/**
 * French Guiana (GF) address configuration.
 *
 ...
 *   Postcode: 5-digit (973\d\d block) BEFORE the commune; "CEDEX nn"
...
export const gfConfig: EuCountryConfig = {
  code: "gf",
  country: "GF",
  countryNames: ["French Guiana", "Guyane française", "Guyane francaise", "Guyane", "GUF", "GF"],
  order: "number-street",
  ...
  postalPattern: "(?<postal_code>973\\d\\d)",
