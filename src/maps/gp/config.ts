...
/**
 * Guadeloupe (GP) address configuration.
 *
 ...
 *   Postcode: 5-digit (971\d\d block) BEFORE the commune; "CEDEX nn"
...
export const gpConfig: EuCountryConfig = {
  code: "gp",
  country: "GP",
  countryNames: ["Guadeloupe", "GLP", "GP"],
  order: "number-street",
  ...
  postalPattern: "(?<postal_code>971\\d\\d)",
