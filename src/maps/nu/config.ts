...
/**
 * Niue (NU) address configuration.
 *
 * Language: English. Order: house NUMBER first, then the street name + a
 * TRAILING English type suffix ("3 Alofi Road"). Type echoed verbatim.
 * Postcode: NONE. Niue has no postal-code system, so the postal slot never matches and the place tail ends at the city (and optional island).
 * Region: none written; districts/villages are the routing locality (city).
 * PO Box is the dominant address form in Niue; "PO Box", "P.O. Box",
...
export const nuConfig: EuCountryConfig = {
  code: "nu",
  country: "NU",
  countryNames: ["Niue", "NIU", "NU"],
