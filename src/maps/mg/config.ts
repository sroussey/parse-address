...
// MG address configuration -- French, number-first, prefix voie type.
// Numbers frequently absent; B.P. (Boîte Postale) is the dominant delivery
// form. Region/province optional (restricted list). See research-mg.md.
...
const QUARTIERS = [
  "Analakely", "Isoraka", "Ambatonakanga", "Antaninarenina", "Ankorondrano",
  "Andraharo", "Ivandry", "Tsaralalàna", "Behoririka", "Ampefiloha",
];

export const mgConfig: EuCountryConfig = {
  code: "mg",
  country: "MG",
  countryNames: ["Madagascar", "MDG", "MG"],
  ...
  // Optional small 3-digit postcode before the city ("101 Antananarivo").
  ...
  regionPattern: "(?<state>Analamanga|Vakinankaratra|Atsinanana|Boeny|Haute\\s+Matsiatra|Diana|Sava|Menabe|Anosy)",
