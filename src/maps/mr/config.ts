...
// MR address configuration -- French, number-first, prefix voie type.
// Numbers frequently absent; B.P. (Boîte Postale) is the dominant delivery
// form. Region/province optional (restricted list). See research-mr.md.
...
const QUARTIERS = [
  "Tevragh Zeina", "Ksar", "Sebkha", "Arafat", "El Mina", "Dar Naim",
  "Teyarett", "Toujounine", "Riyad",
];

export const mrConfig: EuCountryConfig = {
  code: "mr",
  country: "MR",
  countryNames: ["Mauritanie", "Mauritania", "MRT", "MR"],
  ...
  regionPattern: "(?<state>Trarza|Adrar|Assaba|Brakna|Dakhlet\\s+Nouadhibou|Gorgol|Guidimaka|Hodh\\s+Ech\\s+Chargui|Hodh\\s+El\\s+Gharbi|Inchiri|Tagant|Tiris\\s+Zemmour|Nouakchott-Nord|Nouakchott-Ouest|Nouakchott-Sud)",
