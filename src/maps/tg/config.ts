...
// TG address configuration -- French, number-first, prefix voie type.
// Numbers frequently absent; B.P. (Boîte Postale) is the dominant delivery
// form. Region/province optional (restricted list). See research-tg.md.
...
const QUARTIERS = [
  "Tokoin", "Bè", "Nyékonakpoè", "Kodjoviakopé", "Hédzranawoé", "Agbalépédogan",
  "Adidogomé", "Baguida", "Doulassamé",
];

export const tgConfig: EuCountryConfig = {
  code: "tg",
  country: "TG",
  countryNames: ["Togo", "TGO", "TG"],
  ...
  regionPattern: "(?<state>Maritime|Plateaux|Centrale|Savanes)",
