...
/**
 * Mayotte (YT) address configuration.
 *
 ...
 *   Postcode: 5-digit (976\d\d block) BEFORE the commune; "CEDEX nn"
...
export const ytConfig: EuCountryConfig = {
  code: "yt",
  country: "YT",
  countryNames: ["Mayotte", "MYT", "YT"],
  order: "number-street",
  ...
  postalPattern: "(?<postal_code>976\\d\\d)",
