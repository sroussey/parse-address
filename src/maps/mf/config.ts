...
/**
 * Saint-Martin (MF) address configuration.
 *
 ...
 *   Postcode: 5-digit (97150 block) BEFORE the commune; "CEDEX nn"
...
export const mfConfig: EuCountryConfig = {
  code: "mf",
  country: "MF",
  countryNames: ["Saint-Martin", "Saint Martin", "MAF", "MF"],
  order: "number-street",
  ...
  postalPattern: "(?<postal_code>97150)",
