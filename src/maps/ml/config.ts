...
// ML address configuration -- French, number-first, prefix voie type.
// Numbers frequently absent; B.P. (Boîte Postale) is the dominant delivery
// form. Region/province optional (restricted list). See research-ml.md.
...
const QUARTIERS = [
  "Badalabougou", "Hamdallaye", "ACI 2000", "Hippodrome", "Missira",
  "Djelibougou", "Magnambougou", "Faladé", "Sébénikoro", "Kalaban Coura",
];

export const mlConfig: EuCountryConfig = {
  code: "ml",
  country: "ML",
  countryNames: ["Mali", "MLI", "ML"],
  ...
  regionPattern: "(?<state>Koulikoro|Tombouctou|Kidal|Taoudénit|Ménaka)",
