...
/**
 * Wallis-et-Futuna (WF) address configuration.
 *
 ...
 *   Postcode: 5-digit (986\d\d block) BEFORE the commune; "CEDEX nn"
...
export const wfConfig: EuCountryConfig = {
  code: "wf",
  country: "WF",
  countryNames: ["Wallis-et-Futuna", "Wallis and Futuna", "WLF", "WF"],
  order: "number-street",
  ...
  postalPattern: "(?<postal_code>986\\d\\d)",
