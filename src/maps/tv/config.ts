 ...
 * TRAILING English type suffix ("4 Tuvalu Road"). Type echoed verbatim.
 * Postcode: NONE. Tuvalu has no postal-code system, so the postal slot never matches and the place tail ends at the city (and optional island).
 * Region: the island/region (Funafuti, Nanumea, Nanumaga ...) is the final comma segment and maps to `state`.
 * PO Box is the dominant address form in Tuvalu; "PO Box", "P.O. Box",
...
export const tvConfig: EuCountryConfig = {
  code: "tv",
  country: "TV",
  countryNames: ["Tuvalu", "TUV", "TV"],
