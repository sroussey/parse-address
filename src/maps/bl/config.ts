...
/**
 * Saint-Barthélemy (BL) address configuration.
 *
 ...
 *   Postcode: 5-digit (97133 block) BEFORE the commune; "CEDEX nn"
...
export const blConfig: EuCountryConfig = {
  code: "bl",
  country: "BL",
  countryNames: ["Saint-Barthélemy", "Saint-Barthelemy", "Saint Barthelemy", "BLM", "BL"],
  order: "number-street",
  ...
  postalPattern: "(?<postal_code>97133)",
