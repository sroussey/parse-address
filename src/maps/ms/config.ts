...
/**
 * Montserrat (MS) address configuration.
 *
 ...
 *
 * Postcode: National code (e.g. MSR 1110); OPTIONAL, frequently omitted.
 *
...
const STATES: Array<[string, string[]]> = [
  ["Saint Anthony", ["Saint Anthony", "St. Anthony", "St Anthony"]],
  ["Saint Georges", ["Saint Georges", "St. Georges", "St Georges"]],
...
export const msConfig: EuCountryConfig = {
  code: "ms",
  country: "MS",
  countryNames: ["Montserrat", "MSR", "MS"],
  order: "number-street",
  ...
  postalPattern: "(?<postal_code>MSR\\s*\\d{4})",
