...
/**
 * Saint-Pierre-et-Miquelon (PM) address configuration.
 *
 ...
 *   Postcode: 5-digit (975\d\d block) BEFORE the commune; "CEDEX nn"
...
export const pmConfig: EuCountryConfig = {
  code: "pm",
  country: "PM",
  countryNames: ["Saint-Pierre-et-Miquelon", "Saint Pierre and Miquelon", "SPM", "PM"],
  order: "number-street",
  ...
  postalPattern: "(?<postal_code>975\\d\\d)",
