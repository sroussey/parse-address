...
/**
 * Saint Kitts and Nevis (KN) address configuration.
 *
...
const STATES: Array<[string, string[]]> = [
  ["St. Kitts", ["St. Kitts", "Saint Kitts", "St Kitts"]],
  ["Nevis", ["Nevis"]],
];
...
export const knConfig: EuCountryConfig = {
  code: "kn",
  country: "KN",
  countryNames: ["Saint Kitts and Nevis", "St. Kitts and Nevis", "St Kitts and Nevis", "Saint Christopher and Nevis", "KNA", "KN"],
  order: "number-street",
