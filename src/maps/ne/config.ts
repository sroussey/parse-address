...
// NE address configuration -- French, number-first, prefix voie type.
// Numbers frequently absent; B.P. (Boîte Postale) is the dominant delivery
// form. Region/province optional (restricted list). See research-ne.md.
...
const QUARTIERS = [
  "Plateau", "Yantala", "Koira Kano", "Terminus", "Lacouroussou", "Gamkallé",
  "Maourey", "Deizebon", "Recasement",
];

export const neConfig: EuCountryConfig = {
  code: "ne",
  country: "NE",
  countryNames: ["Niger", "NER", "NE"],
  ...
  regionPattern: "(?<state>Agadez|Diffa|Dosso|Maradi|Tahoua|Tillabéri|Zinder)",
