...
/**
 * Polynésie française (PF) address configuration.
 *
 ...
 *   Postcode: 5-digit (987\d\d block) BEFORE the commune; "CEDEX nn"
...
export const pfConfig: EuCountryConfig = {
  code: "pf",
  country: "PF",
  countryNames: ["Polynésie française", "Polynesie francaise", "French Polynesia", "PYF", "PF"],
  order: "number-street",
  ...
  postalPattern: "(?<postal_code>987\\d\\d)",
