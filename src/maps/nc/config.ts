...
/**
 * Nouvelle-Calédonie (NC) address configuration.
 *
 ...
 *   Postcode: 5-digit (988\d\d block) BEFORE the commune; "CEDEX nn"
...
export const ncConfig: EuCountryConfig = {
  code: "nc",
  country: "NC",
  countryNames: ["Nouvelle-Calédonie", "Nouvelle-Caledonie", "New Caledonia", "NCL", "NC"],
  order: "number-street",
  ...
  postalPattern: "(?<postal_code>988\\d\\d)",
